...
### Release
  ...
  - **x64**
    - :white_check_mark:  **[1.6.45](https://github.com/memcached/memcached/releases/tag/1.6.45)**: libevent `2.1.12`  **_2026-07-10_**
      - *gcc `16.1.1` cygwin `3.7.0`*
      - *openssl `3.5.7` libevent `2.1.7` zlib `1.3.2`*
